...
public class GameSetupTest {
    ...
    void whiteTest() {
        ...
        assertTrue(board.getPieceAt(new Position(7,0)) instanceof Archer);
        assertTrue(board.getPieceAt(new Position(7,1)) instanceof Assassin);
        ...
        assertTrue(board.getPieceAt(new Position(7,6)) instanceof Assassin);
        assertTrue(board.getPieceAt(new Position(7,7)) instanceof Archer);
    ...
    void blackTest() {
        Board board = GameSetup.createStandardBoard();
        assertTrue(board.getPieceAt(new Position(0,0)) instanceof Archer);
        assertTrue(board.getPieceAt(new Position(0,1)) instanceof Assassin);
        ...
        assertTrue(board.getPieceAt(new Position(0,6)) instanceof Assassin);
        assertTrue(board.getPieceAt(new Position(0,7)) instanceof Archer);
        for (int col = 0; col < 8; col++)
